  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col gap-4 px-5 pt-4 pb-4">
        ...
        {/* Transaction count for current filter */}
        {filter !== "all" && (
        ...
        {monthKeys.length === 0 ? (
          ...
          monthKeys.map(monthKey => {
            const txs = grouped.get(monthKey)!;
            const monthIncome  = txs.filter(t => t.type === "income"  && t.txType !== "transfer_internal").reduce((s, t) => s + t.amount, 0);
            const monthExpense = txs.filter(t => t.type === "expense" && t.txType !== "transfer_internal").reduce((s, t) => s + t.amount, 0);
              ...
              <div key={monthKey}>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex gap-3">
                    {monthIncome > 0 && (
                      <span className="text-[10px] mono-data" style={{ color: "var(--income)" }}>
                        +{BRL(monthIncome)}
                      </span>
                    )}
                    {monthExpense > 0 && (
                      <span className="text-[10px] mono-data" style={{ color: "var(--expense)" }}>
                        -{BRL(monthExpense)}
                      </span>
                    )}
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                          ...
                          <i className={`fa-solid ${txInfo.icon} text-sm`}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                            ...
                            <span className="text-[10px]" style={{ color: txInfo.color }}>
                              · {txInfo.label}
                            </span>
                            {tx.isRecurring && (
